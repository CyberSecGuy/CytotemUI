...
IRT_LadyInervaDarkveinOptions = CreateFrame("Frame", "IRT_LadyInervaDarkveinOptionsFrame", InterfaceOptionsFramePanelContainer);
IRT_LadyInervaDarkveinOptions.name = L.OPTIONS_LADYINERVADARKVEIN_TITLE;
IRT_LadyInervaDarkveinOptions.parent = "|cFFFFFF00Castle Nathria Modules|r";
...
InterfaceOptions_AddCategory(IRT_LadyInervaDarkveinOptions);