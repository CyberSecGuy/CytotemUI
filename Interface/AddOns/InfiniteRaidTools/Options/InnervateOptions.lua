...
IRT_InnervateOptions = CreateFrame("Frame", "IRT_InnervateOptionsFrame", InterfaceOptionsFramePanelContainer)
IRT_InnervateOptions.name = "Innervate Module"
IRT_InnervateOptions.parent = "|cFFFFFF00General Modules|r"
...
InterfaceOptions_AddCategory(IRT_InnervateOptions)